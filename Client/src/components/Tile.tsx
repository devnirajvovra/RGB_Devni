...
import { ITileProps } from '../shared/interfaces';
...
const Tile: FC<ITileProps> = (props) => {
    const handleDrag = (event: DragEvent) => {
        event.dataTransfer?.setData('id', props.cell.id);
    };
    ...
    return (
        <>
            <TileBody
                data-tip = {props.cell.color.map((colorComponent: any) =>
